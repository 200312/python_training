...
class test_add_contact(unittest.TestCase):
    ...
    def create_contact(self, wd, contact2):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="fghfgthg", lastname="fghgjhgj", address="jgfjgjg", home="gjgjghjhk", email="hgjhjhjkkh"))
    ...
    def test_add_empty_contact(self):
        ...
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.create_contact(wd, Contact(firstname="", lastname="", address="", home="", email=""))
        self.return_home_page(wd)
        self.logout(wd)
